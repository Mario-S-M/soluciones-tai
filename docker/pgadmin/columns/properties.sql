SELECT att.attname as name, att.atttypid, att.attlen, att.attnum, att.attndims,
		...
		att.attstorage, NULL::"char" AS attidentity,
	...
	'n'::text AS colconstype, tab.relname as relname,
...
FROM pg_catalog.pg_attribute att
  ...
  LEFT OUTER JOIN (SELECT NULL::oid AS seqrelid, NULL::oid AS seqtypid, NULL::bigint AS seqstart,
         NULL::bigint AS seqincrement, NULL::bigint AS seqmax, NULL::bigint AS seqmin,
         NULL::bigint AS seqcache, NULL::boolean AS seqcycle) seq ON cs.oid=seq.seqrelid
